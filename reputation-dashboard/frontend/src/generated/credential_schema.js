...
export const CredentialSchemaDocument = {
    ...
    create(base) {
        return CredentialSchemaDocument.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f;
        const message = createBaseCredentialSchemaDocument();
        message.type = (_a = object.type) !== null && _a !== void 0 ? _a : undefined;
        message.modelVersion = (_b = object.modelVersion) !== null && _b !== void 0 ? _b : undefined;
        message.id = (_c = object.id) !== null && _c !== void 0 ? _c : undefined;
        message.name = (_d = object.name) !== null && _d !== void 0 ? _d : undefined;
        message.author = (_e = object.author) !== null && _e !== void 0 ? _e : undefined;
        message.authored = (_f = object.authored) !== null && _f !== void 0 ? _f : undefined;
...
export const CredentialSchemaProperty = {
    ...
    create(base) {
        return CredentialSchemaProperty.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f;
        const message = createBaseCredentialSchemaProperty();
...
export const CredentialSchemaState = {
    ...
    create(base) {
        return CredentialSchemaState.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseCredentialSchemaState();
