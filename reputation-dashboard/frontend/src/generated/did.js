...
export const DidDocument = {
    ...
    create(base) {
        return DidDocument.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.verificationMethod = ((_e = object.verificationMethod) === null || _e === void 0 ? void 0 : _e.map((e) => VerificationMethod.fromPartial(e))) || undefined;
        ...
        message.service = ((_l = object.service) === null || _l === void 0 ? void 0 : _l.map((e) => Service.fromPartial(e))) || undefined;
        return message;
    },
};
...
export const DidDocumentMetadata = {
    ...
    create(base) {
        return DidDocumentMetadata.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseDidDocumentMetadata();
...
export const VerificationMethod = {
    ...
    create(base) {
        return VerificationMethod.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseVerificationMethod();
...
export const Service = {
    ...
    create(base) {
        return Service.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseService();
...
export const DidDocumentState = {
    ...
    create(base) {
        return DidDocumentState.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseDidDocumentState();
